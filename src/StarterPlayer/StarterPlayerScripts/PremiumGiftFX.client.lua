...
-- VIEWERS VS ME - PREMIUM GIFT CINEMATICS V1.2
-- Clean presentation; reliable first-person test controls remain active.
...
local old=playerGui:FindFirstChild("PremiumGiftHUD")
if old then old:Destroy() end

local gui=Instance.new("ScreenGui");gui.Name="PremiumGiftHUD";gui.ResetOnSpawn=false;gui.IgnoreGuiInset=true;gui.DisplayOrder=2600;gui.Parent=playerGui
...
local title=Instance.new("TextLabel");title.Size=UDim2.new(1,-20,.58,0);title.Position=UDim2.fromOffset(10,4);title.BackgroundTransparency=1;title.Font=Enum.Font.GothamBlack;title.TextScaled=true;title.TextColor3=Color3.new(1,1,1);title.Text="";title.Parent=banner
local sub=Instance.new("TextLabel");sub.Size=UDim2.new(1,-20,.34,0);sub.Position=UDim2.new(0,10,.61,0);sub.BackgroundTransparency=1;sub.Font=Enum.Font.GothamBold;sub.TextScaled=true;sub.TextColor3=Color3.fromRGB(215,220,230);sub.Text="";sub.Parent=banner
...
-- Test keys remain, but no permanent bottom-right helper panel anymore.
...
print("PREMIUM GIFT FX V1.2 READY - clean HUD, direct test controls active.")